class sqlQuery {
    ...
    private SqlQuery(Builder builder) {
        this.query = "SELECT " + builder.select + " FROM " + builder.form +
        (builder.where != null ? " WHERE " + builder.where : ";");

    }

    public Srtring getQuery() { return query; }
    ...
    public static class Builder {
        ...
        public SqlQuery build() {
            if (this.from == null) throw new IllegalStateExeption("Error: FROM required.");
